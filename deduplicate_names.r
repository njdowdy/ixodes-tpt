...
source_summary$duplicated_names <- c(BYU_dupes, FMNH_dupes, NMNH_dupes, TOTAL_Dupes)
source_summary$unique_names <- c(BYU, FMNH, NMNH, TOTAL)
...
write.csv(duplicates,"~/GitHub/ixodes-tpt/output/TPT_Siphonaptera_duplicates.csv", row.names = FALSE)
